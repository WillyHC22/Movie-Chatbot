...
import random
from models.models import maskNLLLoss
from src.data_processing_utils import batch2TrainData
...
def train(input_variable, lengths, target_variable, mask, max_target_len, encoder, decoder, embedding,
          encoder_optimizer, decoder_optimizer, batch_size, clip, max_length=MAX_SENTENCE_LENGTH):
